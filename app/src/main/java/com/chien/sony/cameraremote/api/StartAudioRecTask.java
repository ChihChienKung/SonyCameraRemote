 ...
 */
class StartAudioRecTask extends ApiTask<Void, Void, Integer> {

    StartAudioRecTask(RemoteApi remoteApi, IApiResultListener listener) {
    ...
    protected Integer doInBackground(Void... params) {
        int result = -1;
        try {
            JSONObject responseObj = mRemoteApi.startAudioRec();
    ...
    protected void onPostExecute(Integer result) {
        ...
        if (mListener != null)
            mListener.startAudioRecResult(result, id);
    }
}
