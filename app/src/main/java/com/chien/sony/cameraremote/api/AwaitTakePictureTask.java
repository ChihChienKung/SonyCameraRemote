 ...
 */
class AwaitTakePictureTask extends ApiTask<Void, Void, String[]> {

    AwaitTakePictureTask(RemoteApi remoteApi, IApiResultListener listener) {
    ...
    protected String[] doInBackground(Void... params) {
        String[] result = null;
        try {
            JSONObject responseObj = mRemoteApi.awaitTakePicture();
    ...
    protected void onPostExecute(String[] result) {
        ...
        if (mListener != null)
            mListener.awaitTakePictureResult(result, id);
    }
}
