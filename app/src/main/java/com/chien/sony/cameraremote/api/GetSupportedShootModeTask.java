 ...
 */
class GetSupportedShootModeTask extends ApiTask<Void, Void, String[]> {

    GetSupportedShootModeTask(RemoteApi remoteApi, IApiResultListener listener) {
    ...
    protected String[] doInBackground(Void... params) {
        String[] result = null;
        try {
            JSONObject responseObj = mRemoteApi.getSupportedShootMode();
    ...
    protected void onPostExecute(String[] result) {
        ...
        if (mListener != null)
            mListener.getSupportedShootModeResult(result, id);
    }
}
