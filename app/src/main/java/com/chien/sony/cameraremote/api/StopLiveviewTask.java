 ...
 */
class StopLiveviewTask extends ApiTask<Void, Void, Integer> {

    StopLiveviewTask(RemoteApi remoteApi, IApiResultListener listener) {
    ...
    protected Integer doInBackground(Void... params) {
        int result = -1;
        try {
            JSONObject responseObj = mRemoteApi.stopLiveview();
    ...
    protected void onPostExecute(Integer result) {
        ...
        if (mListener != null)
            mListener.stopLiveviewResult(result, id);
    }
}
